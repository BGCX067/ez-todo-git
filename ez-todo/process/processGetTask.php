	...
	*/
	function getTask($user, $connection){
		...
		if($row['assigned_date'] != null){
			...
			$taskHTML .=  "<tr><td>" . $row['id'] . "</td><td><a href=\"./?page=editTask&task=" . $row['id'] . "\">" . $row['task_name']  . "</a></td><td class=\"description\">" . $row['description']  . "</td><td>" . $row['difficulty_type'] . "</td><td>" . $assigned_date . "</td><td>" . $due_date . "</td><td></td></tr>";
		}
