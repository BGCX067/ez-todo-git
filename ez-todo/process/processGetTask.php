	...
	*/
	function getTask($user, $connection){
		...
		while($row = mysqli_fetch_array($results)) {
			$taskHTML .=  "<tr><td>" . $row['id'] . "</td><td><a href=\"./?page=editTask&task=" . $row['id'] . "\">" . $row['task_name']  . "</a></td><td class=\"description\">" . $row['description']  . "</td><td>" . $row['difficulty_type'] . "</td><td>" . $row['assigned_date'] . "</td><td>" . $row['due_date'] . "</td><td></td></tr>";
		}
